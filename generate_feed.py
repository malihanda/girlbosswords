...
def main():
    ...
    for e in reversed(entries):
        if e['girlboss']:
            ...
            # t_print1 = tz.tzwinlocal()
            # print(type(t_print1), t_print1)
            # t_print2 = date.astimezone(t_print1)
            # print(type(t_print2), t_print2)
            fe.published(date.astimezone(tz.tzwinlocal()))
            fe.updated(date.astimezone(tz.tzwinlocal()))
